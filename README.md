...
Tale UI is an opinionated component library built on headless UI primitives for building accessible user interfaces.

---

## Documentation

To get started, check out the [Tale UI documentation](https://base-ui.com/react/overview/quick-start).
...
- **X** To stay up-to-date on new releases and announcements follow [Tale UI on X](https://x.com/base_ui).
